...
class UserForm(forms.ModelForm):
    ...
    def clean(self, *args, **kwargs):
        ...
        error_msg_password_match = 'A senha deve ser iguais'
        error_msg_password_short = 'Sua senha precisa de pelo menos 6 caracteres'
        error_msg_required_fiel = 'Este campo é obrigatorio'
        ...
        if self.usuario:
            ...
            if not password_data:
                ...
                validation_error_msgs['password2'] = error_msg_required_fiel
