...
class Criar(BasePerfil):
    def post(self, *args, **kwargs):
        if not self.userform.is_valid() or not self.perfilform.is_valid():
            messages.error(self.request, 'Erro no formulário de cadastrado')
        ...
        messages.success(self.request, 'Você esta logado')
...
class Logout(View):
    def get(self, *args, **kwargs):
        ...
        if not carrinho:
            return messages.warning(self.request, 'Carrinho vazio')
